				...
				<div class="col-12">
					...
					<div class="form-group row">
						<div class="col-sm-8 col-md-9">
							<?
							$arResult["arUser"]['USER_TYPE_LIST'] = array(
								'4' => 1, //fiz
								'5' => 2, //ur
								'6' => 3, //ip
							);
							...
							?><input type="radio" name="PERSON_TYPE" id="main-profile-type" value="<?= $ptype["ID"] ?>" <? if ($arResult["arUser"]['USER_TYPE_LIST'][$arResult["arUser"]["UF_PAYER_TYPE"]] == $ptype["ID"]) echo " checked"; ?>><? echo $ptype["NAME"] ?><br><?
							}																																																										?>
						</div>
					</div>
