...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:102:"/bitrix/templates/.default/components/bitrix/sale.order.ajax/sale.bonus/order_ajax.js?1698225325237956";s:6:"source";s:85:"/bitrix/templates/.default/components/bitrix/sale.order.ajax/sale.bonus/order_ajax.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
...
(function() {
	...
	BX.Sale.OrderAjaxComponent = {
		...
		init: function(parameters)
		{
			...
			//this.user =  parameters.result.USER_DATA;
		...
		editPaySystemItems: function(paySystemNode)
		{
			...
			var paySystemItemsContainer = BX.create('DIV', {props: {className: 'order-md-1 order-2 col-md-7 bx-soa-pp-item-container'}}),
				...
				console.log(this.result.TOTAL.BONUS);
				if (deliveryType.ID == 3 && Number(this.result.TOTAL.BONUS) > 0) {
		...
		editTotalBlock: function()
		{
			...
			if (this.user) {
				this.totalInfoBlockNode.appendChild(this.createTotalUnit('Ваши бонусные баллы:', this.user.UF_BONUSES));
			}
			bonus = total.BONUS + " руб.";
			this.totalInfoBlockNode.appendChild(this.createTotalUnit(BX.message('SOA_SUM_SUMMARY'), priceHtml, params));
			this.totalInfoBlockNode.appendChild(this.createTotalUnit(BX.message('SOA_SUM_SUMMARY'), bonus));
...
; /* /bitrix/templates/.default/components/bitrix/sale.order.ajax/sale.bonus/order_ajax.js?1698225325237956*/
...
//# sourceMappingURL=page_4d14861fca57895667a435872476c914.map.js