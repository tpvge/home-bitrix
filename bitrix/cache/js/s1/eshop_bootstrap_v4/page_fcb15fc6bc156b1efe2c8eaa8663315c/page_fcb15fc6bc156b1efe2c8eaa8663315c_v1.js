...
; /* Start:"a:4:{s:4:"full";s:103:"/bitrix/components/bitrix/sale.location.selector.search/templates/.default/script.min.js?16968612397747";s:6:"source";s:84:"/bitrix/components/bitrix/sale.location.selector.search/templates/.default/script.js";s:3:"min";s:88:"/bitrix/components/bitrix/sale.location.selector.search/templates/.default/script.min.js";s:3:"map";s:88:"/bitrix/components/bitrix/sale.location.selector.search/templates/.default/script.map.js";}"*/
...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:97:"/bitrix/templates/.default/components/bitrix/sale.order.ajax/sale.bonus/script.js?169807152811313";s:6:"source";s:81:"/bitrix/templates/.default/components/bitrix/sale.order.ajax/sale.bonus/script.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:102:"/bitrix/templates/.default/components/bitrix/sale.order.ajax/sale.bonus/order_ajax.js?1698245826235901";s:6:"source";s:85:"/bitrix/templates/.default/components/bitrix/sale.order.ajax/sale.bonus/order_ajax.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
...
(function() {
	...
	BX.Sale.OrderAjaxComponent = {
		...
		init: function(parameters)
		{
			...
			this.user =  parameters.result.USER;
		...
		getPersonTypeControl: function(node)
		{
			if (!this.result.PERSON_TYPE)
				return;
			let i, oldPersonTypeId;
			this.result.PERSON_TYPE = this.getPersonTypeSortedArray(this.result.PERSON_TYPE);
			console.log(this.result.PERSON_TYPE)

			for (i in this.result.PERSON_TYPE) {
				if (this.result.PERSON_TYPE.hasOwnProperty(i)) {
					if (this.result.PERSON_TYPE[i].CHECKED == 'Y') {
						node.appendChild(BX.create('INPUT', {props: {type: 'hidden', name: 'PERSON_TYPE', value: 1}}));
						oldPersonTypeId = this.result.PERSON_TYPE[i].ID;
					}
				}
			}
		...
		editPaySystemItems: function(paySystemNode)
		{
			...
			var paySystemItemsContainer = BX.create('DIV', {props: {className: 'order-md-1 order-2 col-md-7 bx-soa-pp-item-container'}}),
				...
				const deliveryType = this.getSelectedDelivery();
				console.log(this.user.BONUS);
				if (deliveryType.ID == 3 && Number(this.user.BONUS) > 0) {
					const indexPaySystem = this.result.PAY_SYSTEM.findIndex(obj => obj.ID == 8);
					this.result.PAY_SYSTEM.splice(indexPaySystem, 1);
					// this.result.PAY_SYSTEM = this.result.PAY_SYSTEM.filter((paySystem) => {return paySystem.ID != 8});
				}
		...
		editPropsItems: function(propsNode)
		{
			...
			while (group = groupIterator())
			{
				...
				{	
					...
					if (this.user && property.getId() == 20 && property.getValue().length === 0) {
						property.setValue(this.user.SECOND_NAME);
					}
		...
		editTotalBlock: function()
		{
			...
			if (this.user) {
				bonus = this.user.BONUS + " руб.";
				this.totalInfoBlockNode.appendChild(this.createTotalUnit(BX.message('SOA_BONUS'), bonus));
			}
...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:102:"/bitrix/components/bitrix/sale.location.selector.steps/templates/.default/script.min.js?16968612397752";s:6:"source";s:83:"/bitrix/components/bitrix/sale.location.selector.steps/templates/.default/script.js";s:3:"min";s:87:"/bitrix/components/bitrix/sale.location.selector.steps/templates/.default/script.min.js";s:3:"map";s:87:"/bitrix/components/bitrix/sale.location.selector.steps/templates/.default/script.map.js";}"*/
...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:104:"/bitrix/components/bitrix/main.userconsent.request/templates/.default/user_consent.min.js?16968610647945";s:6:"source";s:85:"/bitrix/components/bitrix/main.userconsent.request/templates/.default/user_consent.js";s:3:"min";s:89:"/bitrix/components/bitrix/main.userconsent.request/templates/.default/user_consent.min.js";s:3:"map";s:89:"/bitrix/components/bitrix/main.userconsent.request/templates/.default/user_consent.map.js";}"*/
...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:113:"/bitrix/templates/.default/components/bitrix/sale.order.ajax/sale.bonus/scripts/yandex_maps.min.js?16980708875892";s:6:"source";s:94:"/bitrix/templates/.default/components/bitrix/sale.order.ajax/sale.bonus/scripts/yandex_maps.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
...
/* End */
;; /* /bitrix/components/bitrix/sale.location.selector.search/templates/.default/script.min.js?16968612397747*/
; /* /bitrix/templates/.default/components/bitrix/sale.order.ajax/sale.bonus/script.js?169807152811313*/
; /* /bitrix/templates/.default/components/bitrix/sale.order.ajax/sale.bonus/order_ajax.js?1698245826235901*/
; /* /bitrix/components/bitrix/sale.location.selector.steps/templates/.default/script.min.js?16968612397752*/
; /* /bitrix/components/bitrix/main.userconsent.request/templates/.default/user_consent.min.js?16968610647945*/
; /* /bitrix/templates/.default/components/bitrix/sale.order.ajax/sale.bonus/scripts/yandex_maps.min.js?16980708875892*/

//# sourceMappingURL=page_fcb15fc6bc156b1efe2c8eaa8663315c.map.js