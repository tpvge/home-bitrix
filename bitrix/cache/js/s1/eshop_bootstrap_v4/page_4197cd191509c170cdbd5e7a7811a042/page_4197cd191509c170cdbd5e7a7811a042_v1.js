...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:102:"/bitrix/templates/.default/components/bitrix/sale.order.ajax/sale.bonus/order_ajax.js?1698244177238325";s:6:"source";s:85:"/bitrix/templates/.default/components/bitrix/sale.order.ajax/sale.bonus/order_ajax.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
	...
	BX.Sale.OrderAjaxComponent = {
		...
		getPersonTypeControl: function(node)
		{
			...
			var personTypesCount = this.result.PERSON_TYPE.length,
				...
				console.log("Asfasft", this.user.PAYER_TYPE);
				console.log(personTypesCount);
			...
			if (personTypesCount > 2)
			{
				for (i in this.result.PERSON_TYPE)
				{
					if (this.result.PERSON_TYPE.hasOwnProperty(3))
					{
						currentType = this.result.PERSON_TYPE[3];
...
; /* /bitrix/templates/.default/components/bitrix/sale.order.ajax/sale.bonus/order_ajax.js?1698244177238325*/
...
//# sourceMappingURL=page_4197cd191509c170cdbd5e7a7811a042.map.js